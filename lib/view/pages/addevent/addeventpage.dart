          ...
          appBar: AppBar(
            ...
            actions: [IconButton(
              onPressed: () async {
                ...
                Events data=Events(title: _titlecontroller.text,Image: img,venue: _venuecontroller.text,starttime: 'h',endtime: 's',description: _descontroller.text,price: _stallcontroller.text,stall: _stallcontroller.text,educriteria: _controller.degree!,agecriteria: _controller.age!);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    customTextField('Description', _descontroller, (value) => null),
                    const SizedBox(
                      height: 10,
                    ),
                    ...
                    customTextField('\$', _paymentcontroller, (value) => null,type:TextInputType.number ,),
                    const SizedBox(
                      height: 10,
                    ),
                    const Text('Venue',
                    ...
                    customTextField('Where is the event', _venuecontroller, (value) => null),const SizedBox(
                      height: 10,
                    ), const SizedBox(
                      height: 10,
                    ),
                    ...
                    customTextField('Stalls', _stallcontroller, (value) => null,type:TextInputType.number ,),
                  ...
                  const SizedBox(height: 10,),Container(
                    ...
                    GestureDetector(
                        ...
                        child: image==null?Container(
                          ...
                          color: Colors.grey.withOpacity(0.2),
                        ):Image.file(File(image!.path),height: Get.height / 5,
